...
function VolunteerLogin() {
  ...
  const handleLogin = (e) => {
    ...
    const registeredUser = JSON.parse(localStorage.getItem('volunteerUser'));
    ...
    if (
      ...
      localStorage.setItem('userType', 'volunteer'); // optional use
  ...
  return (
    ...
    >
      <div className="bg-black bg-opacity-60 p-8 rounded-lg shadow-lg max-w-sm w-full text-white relative">
        ...
        <h2 className="text-3xl font-bold mb-6 text-center">Volunteer Login</h2>
        ...
        <p className="text-center text-sm mt-4">
          Not a volunteer?{' '}
          <Link to="/signup/volunteer" className="text-yellow-400 hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
